...
if (! ((isset($_SESSION["admin"])) ||(isset($_SESSION["chief_editor"]))  ||(isset($_SESSION["editor"])) ||(isset($_SESSION["data_entry"])) ||(isset($_SESSION["contributor"])))){
...
<html lang="en">
  ...
  <script type = "text/javascript" >
    history.pushState(null, null, 'log.php');
...
<div class="navbar">
    <div class="navbar-inner">
     ...
     <form action="" class="navbar-search pull-left">
         ...
         <a href="./php/profile.php" role="button" class="btn btn-primary" >My Profile</a>
  
     
         
		<a href="./php/logout.php" role="button" class="btn btn-primary" >Logout</a>
...
<div class="row-fluid">
	...
	<div class="span5">
		...
		<form class="well form-inline" name="reg2" action="../Infigo/index1.php" method="post">
